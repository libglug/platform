...
GLUG_LIB_API bool               glug_plat_os_version(struct glug_plat *, struct glug_plat_version *);
GLUG_LIB_API bool               glug_plat_kernel_version(struct glug_plat *, struct glug_plat_version *);
